...
module.exports = {
    ...
    category: "moderation",
    aliases: ['add-role', 'addrole', 'add-cargo', 'darcargo'],
    run: async (client, message, args) => {
        ...
        if (!args[0]) return message.reply({ content: `${message.author}, Mencione ou informe o ID de algum usuário para adicionar o cargo!` });
            ...
            message.reply({
                embeds: [
                    new EmbedBuilder()
                        ...
                        .setDescription(`<a:CERTO:1213127081890938982> **|** O cargo foi adicionado em **${member.user.username}**!`)
                        .setColor("#6d00a8")
                        .setTimestamp()
                ]
            });
        } catch (err) {
            return message.channel.send({ content: `${message.author}, Falha em adicionar o cargo!` });
        }
    }
}
// autor Mel
