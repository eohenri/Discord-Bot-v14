...
module.exports = {
    ...
    run: async (client, message, args, prefix) => {
        ...
        const api = new Topgg.Api("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjExMDg1NjI2NzM4OTkxNDMxNjgiLCJib3QiOnRydWUsImlhdCI6MTcwMjY0MjgyOX0.paRX3TbqSzocwrG6AJBxNpqoYfvQkKcDj2dZlNiEwNE");
